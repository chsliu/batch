REM call %~dp0\..\ShooterSubPyDownloader\sendemail.shootersuball.bat "\\hv2\Library"

REM call %~dp0\..\ShooterSubPyDownloader\sendemail.shootersuball.bat "\\hv2\Media"

REM call %~dp0\..\ShooterSubPyDownloader\sendemail.shootersuball.bat "\\hv3\Library"

REM call %~dp0\..\ShooterSubPyDownloader\sendemail.shootersuball.bat "\\hv3\Media"

REM call %~dp0\..\ShooterSubPyDownloader\sendemail.shootersuball.bat "\\hv4\Library"
